...
require_once 'google_storage_api/Google/Client.php';
require_once 'google_storage_api/Google/Auth/AssertionCredentials.php';
require_once 'google_storage_api/Google/Service/Datastore.php';
